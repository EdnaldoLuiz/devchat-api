...
public class PasswordPolicy {
    ...
    /**
     * Construtor responsável por inicializar a política de senhas com as regras definidas.
     * Utiliza um {@link ResourceBundleMessageResolver} para carregar mensagens personalizadas
    ...
    /**
     * Gera uma senha forte automaticamente seguindo as regras mínimas de complexidade.
     * A senha gerada conterá uma combinação de letras maiúsculas, minúsculas, números
     * e caracteres especiais, com um comprimento definido em {@code MAX_GENERATED_PASSWORD_LENGTH}.
     *
     * @return Uma senha gerada aleatoriamente que atende aos requisitos de segurança.
     */
